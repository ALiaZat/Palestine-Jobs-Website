...
<body>
    ...
    <div data-collapse="medium" data-animation="default" data-duration="400" role="banner" class="navigation-bar w-nav">
        <div class="w-container"><a href="/" class="brand-link w-nav-brand">
            ...
            <nav role="navigation" class="navigation-menu w-nav-menu">
                <a href="../views/home.php?id=<?php echo $userid ?>" aria-current="page" class="navigation-link w-nav-link "><span class="glyphicon glyphicon-home"></span> Home</a>
                <a href="../views/alljobs.php?id=<?php echo $userid ?>" aria-current="page" class="navigation-link w-nav-link"><span class="glyphicon glyphicon-list"></span> All Jobs</a>
                <div class="user-nav"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRI_80u_uzadF91vm9XQO6kgsYzCXHcQMYlKg8UR4Wrzf6RrSfY7T9hYWQGoG7CA-hLpFc&usqp=CAU" loading="lazy" alt="" class="image-4" />
                    <div data-hover="" data-delay="0" class="w-dropdown">
                        ...
                        <nav class="w-dropdown-list">
                            <a href="manageAds.php?id=<?php echo $userid ?>" class="w-dropdown-link "><span class="glyphicon glyphicon-cog"></span> Manage Ads</a>
                            <a href="../Admin/controlPanel.php?id=<?php echo $userid ?>" class="w-dropdown-link"><span class="glyphicon glyphicon-cog"></span> Control Panel</a>
                ...
                <div class="row main-content bg-success text-center">
                    ...
                    <div class="col-md-8 col-xs-12 col-sm-12 login_form ">
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <form control="" class="form-group" action="update.php?ads_id=<?php echo $ad['adsID']; ?>&id=<?php echo $id ?>" method="post">
                                    <div class="row">
                                        <input type="text" name="ads_title" id="ads_title" class="form__input" placeholder="Enter Ads Title.." value="<?php echo $ad['ads_title']; ?>">
                                    </div>
                                    <div class="row">
                                        <input type="text" name="ads_image" id="ads_image" class="form__input" placeholder="Enter Image URL.." value="<?php echo $ad['ads_image']; ?> ">
                                    </div>
                                    <div class="row">
                                        <input type="text" name="ads_url" id="ads_url" class="form__input" placeholder="Enter Ads URL.." value="<?php echo $ad['ads_url']; ?> ">
                                    </div>
                                    <div class="row">
                                        <textarea name="ads_desc" class="form-control" rows="5" placeholder="<?php echo $ad['ads_desc']; ?>"></textarea>
                                    </div>
                                    <div class="row">
                                        <input type="submit" value="Update" name="adds" class="btn">
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <?php
        ...
        header("location:manageUsers.php?id=$userid");
    }
    ?>
