...
<head>
    ...
    <link rel="stylesheet" href="../addJob/jobForm.css" type="text/css">
                    ...
                    <div class="user-nav"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRI_80u_uzadF91vm9XQO6kgsYzCXHcQMYlKg8UR4Wrzf6RrSfY7T9hYWQGoG7CA-hLpFc&usqp=CAU" loading="lazy" alt="" class="image-4" />
                        <div data-hover="" data-delay="0" class="w-dropdown">
                            ...
                            <nav class="w-dropdown-list">
                                <a href="manageJobs.php?id=<?php echo $user['userID']; ?>" class="w-dropdown-link "><span class="glyphicon glyphicon-cog"></span> Manage Jobs</a>
            ...
            foreach ($jobs as $job) {  ?>
                <div class=" contact-form">
                    <div class="contact-image">
                        <img src="../intro_img.png" alt="rocket_contact" />
                    </div>
                    <form method="post" action="updateJob.php?job_id=<?php echo $job['jobID']; ?>&id=<?php echo $user['userID']; ?>">
                        <div>
                            <h2>Update</h2><br>
                            <h2> <?php echo "(" . $job['jobTitle'] . ")"; ?>Job</h2>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <!-- Job title -->
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Job Title" name="jobTitle" value="<?php echo $job['jobTitle']; ?>">
                                </div><br>
                                <!-- Company Name -->
                                <div class="form-group ">
                                    <label for="companyName">Company name:</label>
                                    <input type="text" class="form-control" placeholder="Enter company name" name="companyName" value="<?php echo $job['companyName']; ?>">
                                </div><br>
                                <!-- Company telephone-->
                                <div class="form-group">
                                    <label for="teleNo">Company's Telephone Number:</label>
                                    <input type="text" class="form-control" placeholder="Enter telephone" name="teleNo" value="<?php echo $job['teleNo']; ?>">
                                </div><br>
                                <!-- Company email-->
                                <div class="form-group">
                                    <label for="email">Company's Email</label>
                                    <input type="email" name="email" class="form-control" placeholder="Enter email" value="<?php echo $job['email']; ?>">
                                </div><br>
                                <!-- Company address-->
                                <div class="form-group">
                                    <label for="address">Company's Address</label>
                                    <input type="text" name="address" class="form-control" placeholder="Enter address" value="<?php echo $job['address']; ?>">
                                </div><br>
                                <!-- Company city-->
                                <div class="form-group">
                                    <label for="city">Company's City</label>
                                    <input type="text" name="city" class="form-control" placeholder="Enter city" value="<?php echo $job['city']; ?>">
                                </div><br>
                                <!--company type-->
                                <div class="form-group">
                                    <label for="comp_type">Company's Type</label><br>
                                    <select class="form-control" name="comp_type">
                                        <option><?php echo $job['comp_type']; ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="website" class="form-control" placeholder="Enter website's URL " value="<?php echo $job['website']; ?>">
                                </div><br>
                                <!-- Company image-->
                                <div class="form-group">
                                    <label for="image">Company's Image</label>
                                    <input type="text" name="image" class="form-control" placeholder="Enter image's URL" value="<?php echo $job['image']; ?>">
                                </div><br>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="fl_pa_time">
                                        <option value><?php echo $job['fl_pa_time']; ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="category">
                                        <option value><?php echo $job['category']; ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter salary" name="salary" value="<?php echo $job['salary']; ?>">
                                </div><br>
                                <!--Job Description-->
                                <div class="form-group">
                                    <label for="jobDescription">Job Description:</label>
                                    <textarea name="jobDescription" class="form-control" rows="5" placeholder="<?php echo $job['jobDescription']; ?>"></textarea>
                                </div><br>
                                <!--JobRequirment-->
                                <div class="form-group">
                                    <label for="jobRequirment">Job Requirment:</label>
                                    <textarea name="jobRequirment" class="form-control" rows="5" placeholder="<?php echo $job['jobRequirment']; ?>"></textarea>
                                </div><br>
                                <div class="checkbox">
                                    <label><input type="checkbox" name="sponsored" value="sponsored" <?php echo ($job['sponsored'] == 1 ? 'checked' : ''); ?>> Sponsored?</label>
                                </div><br>
                                <!-- .............. submit button ................ -->
                                <div class="form-group">
