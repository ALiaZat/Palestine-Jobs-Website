            ...
            <div data-collapse="medium" data-animation="default" data-duration="400" role="banner" class="navigation-bar w-nav">
                <div class="w-container"><a href="/" class="brand-link w-nav-brand">
                    ...
                    <nav role="navigation" class="navigation-menu w-nav-menu">
                        ...
                        <a href="alljobs.php?id=<?php echo $user['userID']; ?>" aria-current="page" class="navigation-link w-nav-link"><span class="glyphicon glyphicon-list"></span> All Jobs</a>
                        ...
                        <div class="user-nav"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRI_80u_uzadF91vm9XQO6kgsYzCXHcQMYlKg8UR4Wrzf6RrSfY7T9hYWQGoG7CA-hLpFc&usqp=CAU" loading="lazy" alt="" class="image-4" />
                            <div data-hover="" data-delay="0" class="w-dropdown">
                                ...
                                <nav class="w-dropdown-list">
                                    <a href="../addJob/announcement.php?id=<?php echo $user['userID']; ?>" class="w-dropdown-link"><span class="glyphicon glyphicon-list"></span> My Announcements</a>
                    ...
                    <nav role="navigation" class="navigation-menu w-nav-menu">
                        ...
                        <div class="user-nav"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRI_80u_uzadF91vm9XQO6kgsYzCXHcQMYlKg8UR4Wrzf6RrSfY7T9hYWQGoG7CA-hLpFc&usqp=CAU" loading="lazy" alt="" class="image-4" />
                            <div data-hover="" data-delay="0" class="w-dropdown">
                                ...
                                <nav class="w-dropdown-list">
                                    <a href="../views/profile.php?id=<?php echo $user['userID']; ?>" class="w-dropdown-link"><span class="glyphicon glyphicon-user"></span> Profile</a>
                                    <a href="../userAuthentication/logout.php" class="w-dropdown-link"><span class="glyphicon glyphicon-log-out"></span> Logout</a>
                                </nav>
                            </div>
                        </div>
            ...
            <div data-ix="fade-in-bottom-page-loads">
                <div class="w-form">
                    <form id="email-form" name="email-form" data-name="Email Form" class="form-2" action="../search.php" method="post">
                        ...
                        <input type="search" class="text-field-3 w-input" maxlength="256" name="jobTitle" data-name="Field 2" placeholder="     Job Title or keyword .." id="field-2" style="padding-left: 3em;" />
            ...
            <div class="w-row">
                <div class="w-col w-col-6">
                    <div data-w-id="270e8437-efa3-df11-d438-de69b23e41e9" style="opacity:0" class="white-box">
                        <img src="../images/about-us1.jpg" loading="lazy" width="320" sizes="(max-width: 479px) 70vw, 320px" alt="about-us img" class="image" />
                    </div>
                </div>
                <div class="w-col w-col-6">
            ...
            <div class="w-row">
                <div class="column w-col w-col-6">
                    <div class="white-box transparent"><img src="../images/seeker.jpg" loading="lazy" height="196" alt="" class="fullwidth-image seeker-img" />
                        <h3 class="white-text">Easiest way to find your dream job</h3><a href="alljobs.php?id=<?php echo $user['userID']; ?>.php" class="hollow-button">Find a job</a>
                    </div>
                </div>
                <div class="w-col w-col-6">
            ...
            <div data-duration-in="300" data-duration-out="100" class="tabs-wrapper w-tabs">
                ...
                <div class="w-tab-content">
                    ...
                    <div data-w-tab="Tab 1" class="w-tab-pane w--tab-active">
                        <a style="    position: relative;color: coral;font-size: 20px;left: 42%;" href="alljobs.php?id=<?php echo $id; ?>">See All Jobs --></a>
